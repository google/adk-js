 ...
 */
const BASE_AGENT_SIGNATURE_SYMBOL = Symbol('ADK_AGENT');
 ...
 */
export function isAdkAgentInstance(obj: unknown): obj is BaseAgent {
  if (typeof obj !== 'object' || obj === null) {
    return false;
  }

  return (obj as BaseAgent)[BASE_AGENT_SIGNATURE_SYMBOL] === true;
}
