...
import {SpanExporter, ReadableSpan, SpanProcessor} from '@opentelemetry/sdk-trace-base';
import {maybeSetOtelProviders, getGcpExporters, getGcpResource, OTelHooks} from '@google/adk';
...
export class ApiServerSpanExporter implements SpanExporter {
  private traceDict: Record<string, any>;

  constructor(traceDict: Record<string, any>) {
