...
export const REQUEST_CLARIFICATION_LABEL = process.env.REQUEST_CLARIFICATION_LABEL ?? "";
...
export const GRAPHQL_COMMENT_LIMIT: number = parseInt(process.env.GRAPHQL_COMMENT_LIMIT ?? "30",10);
...
export const GRAPHQL_TIMELINE_LIMIT: number = parseInt(process.env.GRAPHQL_TIMELINE_LIMIT ?? "20", 10);
